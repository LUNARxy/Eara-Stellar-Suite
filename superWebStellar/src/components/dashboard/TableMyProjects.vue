<template>
  ...
  <div class="row margin-0 padding-0 padding-0">
    <div class="col s12">
              ...
              <div v-if="item.status === INVEST_STATUS_FINISHED" class="col s12 padding-0 mt-2">
                <div class="col s12 ">
                  <div class="card bg-grey padding-3 text-center">
                    ...
                    <p>{{ $t('views.El proyecto se ha completado y se ha efectuado una devolución a su favor de la inversión inicial por una cantidad_', {value: myFormatNumber(item.refund_value), currency: this.VUE_APP_WHITE_LABEL_CURRENCY}) }}</p>
                  </div>
                </div>
              </div>
